...
-- Migration: Remove tax_amount, total_amount, and notes columns from invoices table
-- Run these commands in your Supabase SQL Editor if you have existing data
...
-- ALTER TABLE public.invoices DROP COLUMN IF EXISTS notes;