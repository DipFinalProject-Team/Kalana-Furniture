...
const OffersPage = () => {
  ...
  const paginatedProducts = discountedProducts.slice(startIndex, startIndex + itemsPerPage);
        ...
        <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 border border-wood-brown rounded-lg p-6 bg-wood-brown bg-opacity-60">
            ...
            <p className="mt-4 text-xl text-white">
              Discover amazing deals on our premium furniture collection ({discountedProducts.length} items on sale)
            </p>
          </div>
