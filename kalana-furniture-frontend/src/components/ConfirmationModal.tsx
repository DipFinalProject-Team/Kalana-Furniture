        ...
        <div className="p-6">
          ...
          <div className="flex gap-3 justify-end">
            ...
            <button
              ...
              className="px-5 py-2.5 rounded-lg bg-wood-accent text-white font-medium hover:bg-wood-accent-hover shadow-lg shadow-wood-accent/20 transition-all transform hover:-translate-y-0.5 focus:ring-2 focus:ring-wood-accent"
            >
              {confirmText}
            </button>
          </div>
